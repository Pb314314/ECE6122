...
int main( void )
{
	...
	do{
		...
		//draw rectangle:
		glUseProgram(rec_programID);

		glm::mat4 rec_ModelMatrix = glm::mat4(1.0);
		
		// Our ModelViewProjection : multiplication of our 3 matrices
		glm::mat4 rec_MVP = ProjectionMatrix * ViewMatrix * rec_ModelMatrix; // Remember, matrix multiplication is the other way around


		glUniformMatrix4fv(rec_MatrixID, 1, GL_FALSE, &rec_MVP[0][0]);

		glEnableVertexAttribArray(rec_vertexPosition_modelspaceID);
		glBindBuffer(GL_ARRAY_BUFFER, rec_vertexbuffer);
		glVertexAttribPointer(
			rec_vertexPosition_modelspaceID, // The attribute we want to configure
			3,                  // size
			GL_FLOAT,           // type
			GL_FALSE,           // normalized?
			0,                  // stride
		...
		ModelMatrix1 = glm::translate(ModelMatrix1, glm::vec3(1.8f, 0.0f, 0.99f));
		ModelMatrix1 = glm::rotate(ModelMatrix1, glm::radians(90.0f), glm::vec3(0, 1, 0));
		ModelMatrix1 = glm::rotate(ModelMatrix1, glm::radians(90.0f), glm::vec3(0, 0, 1));
		...
		ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(-1.8f, 0.0f, 0.99f));
		ModelMatrix2 = glm::rotate(ModelMatrix2, glm::radians(270.0f), glm::vec3(0, 1, 0));
		ModelMatrix2 = glm::rotate(ModelMatrix2, glm::radians(270.0f), glm::vec3(0, 0, 1));
		...
		ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, 1.8f, 0.99f));
		ModelMatrix3 = glm::rotate(ModelMatrix3, glm::radians(270.0f), glm::vec3(1, 0, 0));
		ModelMatrix3 = glm::rotate(ModelMatrix3, glm::radians(180.0f), glm::vec3(0, 0, 1));
		...
		ModelMatrix4 = glm::translate(ModelMatrix4, glm::vec3(0.0f, -1.8f, 0.99f));
		ModelMatrix4 = glm::rotate(ModelMatrix4, glm::radians(90.0f), glm::vec3(1, 0, 0));
		//ModelMatrix4 = glm::rotate(ModelMatrix4, glm::radians(180.0f), glm::vec3(0, 0, 1));
